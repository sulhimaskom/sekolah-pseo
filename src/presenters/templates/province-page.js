...
<body>
  ...
  <main id="main-content" role="main">
    ${generateHeroHtml({
      title: `Provinsi ${escapeHtml(provinceName)}`,
      description: `Jelajahi daftar sekolah-sekolah di Provinsi ${escapeHtml(provinceName)}. 
      ...
      stats: [
        ...
        { value: kabupatenList.length, label: T.CITY_REGENCY },
      ],
    })}
