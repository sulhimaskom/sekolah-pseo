...
<body>
  ...
  <main id="main-content" role="main">
    <article aria-labelledby="school-name">
      ...
      <section aria-labelledby="school-details">
        <h2 id="school-details" class="sr-only">${escapeHtml(CONFIG.TEXT.SCHOOL_DETAILS)}</h2>
          ...
          <div class="details-group">
            ...
            <dd>
              <div class="copy-wrapper">
                ...
                <button class="btn-copy" aria-label="${escapeHtml(CONFIG.TEXT.COPY_NPSN)}" data-copy="${escapeHtml(school.npsn)}">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>
                </button>
                <span class="copy-feedback" aria-hidden="true">${escapeHtml(CONFIG.TEXT.COPIED)}</span>
              </div>
            </dd>
  ...
  <footer role="contentinfo">
    <p>&copy; ${currentYear} Sekolah PSEO. ${escapeHtml(CONFIG.TEXT.FOOTER_TEXT)}</p>
  </footer>
