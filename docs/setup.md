...
| `npm run cli`                     | Launch interactive CLI menu                                          |
| `npm run lint`                    | Lint JavaScript code with ESLint                                     |
| `npm run format`                  | Format code with Prettier                                            |
| `npm run format:check`            | Check formatting without modifying files                             |
| `npm run coverage`                | Run JS tests with coverage threshold check (80% lines, 75% branches) |
| `npm run coverage:report`         | Run JS tests with coverage output (HTML/text reports, no threshold)  |
| `npm run test`                    | Run all tests (JavaScript + Python)                                  |
| `npm run test:js`                 | Run JavaScript tests only                                            |
| `npm run test:js:coverage`        | Run JS tests with coverage threshold check (80% lines, 75% branches) |
| `npm run test:js:coverage:report` | Run JS tests with coverage output (HTML/text reports, no threshold)  |
