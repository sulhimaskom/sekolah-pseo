# Issue Records — 178th Batch (Delta, 219th verification, 2026-08-16)

**Evaluation Date**: 2026-08-16
**Evaluator**: Sisyphus (ULW Loop, autonomous run)
**Basis**: 218th audit matrix on `76a8424`, re-executed fresh this run (see
`191-audit-report-2026-08-16-219th.md`).
**Convention**: GitHub issue creation is denied for this integration token (F002 —
`GraphQL: Resource not accessible by integration (createIssue)`, **207th
...
## This run: 0 open PRs / 0 open issues → Phase 1 audit only — composite **70.4 (±0.0, 23rd flat)**, no new findings, no source delta; F037 120th obs, F038 48d, F002 207th, F005 **102 files held (67th observation)**, F018 27d held, F008 RESOLVED maintained (41L + 11 modules), F029 NOT re-observed, 1121 JS + 27 py green, coverage 95.57/93.07, pull CI window **7/0/1 zero-failure maintained** with 50th+51st+52nd+53rd+54th+55th+56th+57th+58th+59th+60th+61st+62nd+63rd+64th+65th+66th+67th+68th windows SUCCESS ×19 back-to-back (69th win in-prog), F063 IMPROVING, pytest 13/13 + run_tests 27/27

## Open findings (held)

| ID   | Category    | Priority | Title                                                                                                                                                                                                                                                                           | State            |
| ---- | ----------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| F037 | security    | P0       | Workflow security: 12 violations (2 CRITICAL DUPLICATE_API_KEY + 10 HIGH)                                                                                                                                                                                                       | HELD (120th obs) |
| F038 | ci          | P1       | Orchestrator workflow fails 6/6 (checkout exit 128, 48 days)                                                                                                                                                                                                                    | HELD (48 days)   |
| F002 | chore       | P1       | GitHub issue creation denied for integration token (207th denial)                                                                                                                                                                                                               | HELD             |
| F044 | security    | P2       | Over-scoped secrets: 10 unique names / 59 refs across workflows + template                                                                                                                                                                                                      | HELD             |
| F005 | chore       | P2       | 102 docs/issues ledger files fail `prettier --check` (67th observation; **count held at 102**)                                                                                                                                                                                  | HELD/FLAT        |
...
| F063 | ci          | P1       | pull CI hourly — **7/0/1, zero-failure window maintained**; 50th+51st+52nd+53rd+54th+55th+56th+57th+58th+59th+60th+61st+62nd+63rd+64th+65th+66th+67th+68th windows (04:28Z → 20:13Z) SUCCESS ×19 back-to-back (69th = this run in-prog); F038 remains the structural CI failure | IMPROVING        |
...
through `76a8424`, so no new source surface exists): duplication clusters →
...
category + one priority label. The F005 count held at 102 — the 218th run's
files 188–190 were prettier-formatted at commit, and this run's files 191–193
...
in a clean, buildable, green state (see `191-audit-report-2026-08-16-219th.md`).
New ledger files 191–193 are prettier-formatted at commit to keep F005 from
rising beyond 102.
