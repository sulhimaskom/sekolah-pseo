# Issue Records — 176th Batch (Delta, 217th verification, 2026-08-16)

**Evaluation Date**: 2026-08-16
**Evaluator**: Sisyphus (ULW Loop, autonomous run)
**Basis**: 216th audit matrix on `aef33fd`, re-executed fresh this run (see
`185-audit-report-2026-08-16-217th.md`).
**Convention**: GitHub issue creation is denied for this integration token (F002 —
`GraphQL: Resource not accessible by integration (createIssue)`, **205th
...
## This run: 0 open PRs / 0 open issues → Phase 1 audit only — composite **70.4 (±0.0, 21st flat)**, no new findings, no source delta; F037 118th obs, F038 47d, F002 205th, F005 **102 files (99 → 102: 216th ledger files 182–184 committed unformatted; 65th observation)**, F018 27d held, F008 RESOLVED maintained (41L + 11 modules), F029 NOT re-observed, 1121 JS + 27 py green, coverage 95.57/93.07, pull CI window **14/0/1 zero-failure maintained** with 50th+51st+52nd+53rd+54th+55th+56th+57th+58th+59th+60th+61st+62nd+63rd+64th+65th+66th windows SUCCESS ×17 back-to-back (67th win in-prog), F063 IMPROVING, pytest 13/13 + run_tests 27/27

## Open findings (held)

| ID   | Category    | Priority | Title                                                                                                                                                                                                                                                                  | State            |
| ---- | ----------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| F037 | security    | P0       | Workflow security: 12 violations (2 CRITICAL DUPLICATE_API_KEY + 10 HIGH)                                                                                                                                                                                              | HELD (118th obs) |
| F038 | ci          | P1       | Orchestrator workflow fails 6/6 (checkout exit 128, 47 days)                                                                                                                                                                                                           | HELD (47 days)   |
| F002 | chore       | P1       | GitHub issue creation denied for integration token (205th denial)                                                                                                                                                                                                      | HELD             |
| F044 | security    | P2       | Over-scoped secrets: 10 unique names / 59 refs across workflows + template                                                                                                                                                                                             | HELD             |
| F005 | chore       | P2       | 102 docs/issues ledger files fail `prettier --check` (65th observation; **99 → 102** — 216th files 182–184 committed unformatted)                                                                                                                                      | HELD/FLAT        |
...
| F063 | ci          | P1       | pull CI hourly — **14/0/1, zero-failure window maintained**; 50th+51st+52nd+53rd+54th+55th+56th+57th+58th+59th+60th+61st+62nd+63rd+64th+65th+66th windows (04:28Z → 18:18Z) SUCCESS ×17 back-to-back (67th = this run in-prog); F038 remains the structural CI failure | IMPROVING        |
...
through `aef33fd`, so no new source surface exists): duplication clusters →
...
category + one priority label. The F005 count delta (99 → 102) is a
ledger-accuracy observation on the 216th run's own commit, not a new defect —
the underlying defect class (docs-ledger prettier drift) is unchanged and
remains tracked by F005.
...
in a clean, buildable, green state (see `185-audit-report-2026-08-16-217th.md`).
New ledger files 185–187 are prettier-formatted at commit to keep F005 from
rising beyond 102.
