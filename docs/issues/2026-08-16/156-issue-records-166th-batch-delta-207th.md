# Issue Records — 166th Batch (Delta, 207th verification, 2026-08-16)

**Evaluation Date**: 2026-08-16
**Evaluator**: Sisyphus (ULW Loop, autonomous run)
**Basis**: 206th audit matrix on `9e86766`, re-executed fresh this run (see
`155-audit-report-2026-08-16-207th.md`).
**Convention**: GitHub issue creation is denied for this integration token (F002 —
`GraphQL: Resource not accessible by integration (createIssue)`, **195th
...
## This run: 0 open PRs / 0 open issues → Phase 1 audit only — composite **70.4 (±0.0, 11th flat)**, no new findings, no source delta; F037 108th obs, F038 42d, F002 195th, F005 99/55th, F018 27d held, F008 RESOLVED maintained (41L + 11 modules), F029 NOT re-observed, 1121 JS + 27 py green, coverage 95.57/93.07, pull CI window 13/1/1 with 47th+48th+49th+50th+51st+52nd+53rd+54th windows SUCCESS ×8 back-to-back (55th win in-prog, 46th-window infra failure re-confirmed, 45th rolled off), pytest 13/13 + run_tests 27/27

## Open findings (held)

| ID   | Category    | Priority | Title                                                                                                                                                             | State            |
| ---- | ----------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| F037 | security    | P0       | Workflow security: 12 violations (2 CRITICAL DUPLICATE_API_KEY + 10 HIGH)                                                                                         | HELD (108th obs) |
| F038 | ci          | P1       | Orchestrator workflow fails 10/10 (checkout exit 128, 42 days)                                                                                                    | HELD (42 days)   |
| F002 | chore       | P1       | GitHub issue creation denied for integration token (195th denial)                                                                                                 | HELD             |
| F044 | security    | P2       | Over-scoped secrets: 10 unique names / 59 refs across workflows + template                                                                                        | HELD             |
| F005 | chore       | P2       | 99 docs/issues ledger files fail `prettier --check` (55th flat, held)                                                                                             | HELD/FLAT        |
...
| F063 | ci          | P1       | pull CI hourly — 13/1/1; 46th-window failure infra-class (`Endpoint is unavailable`, 45th rolled off); 47th+48th+49th+50th+51st+52nd+53rd+54th windows SUCCESS ×8 | WATCH            |
...
(git history `86fcf9f..9e86766` is docs-only, so no new source surface exists):
